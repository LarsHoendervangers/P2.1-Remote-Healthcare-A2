...
namespace TestVREngine
{
    class BasicScene
    {
        ...
        private string AddModels()
        {
            ...
            Handler.SendToTunnel(JSONCommandHelper.Wrap3DObject("podracer", "data/NetworkEngine/models/podracer/podracer.obj", new Transform(1 , new int[3] { 0, 0, 0}, new int[3] { 0, 0, 0 })), new Action<string>(onObjectReceived));
